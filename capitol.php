...
<head>
	...
	<title>SHERPA | Grupo Capitol es un conjunto de empresas de diferentes áreas y rubros empresariales.</title>
	...
	<meta name="description" content="Munro & Asoc. Es un joven y moderno bufete de abogados enfocados en distintas áreas de práctica pero especializados en inmobiliario, ambiental y legal.">
		...
		<div class="container">
			<div class="row" id="portafolio">
				<div class="col-xs-12 col-sm-4 hidden-sm hidden-md hidden-lg">
					<p class="porta-titulo thin">CAPITOL</p>
					<p>Capitol es un corporativo que abarca diferentes rubros empresariales. El proyecto nació en la necesidad de fortalecer y sobre todo de proyectar la posición y altura empresarial que corresponde al grupo. Se trabajo para formar una marca paraguas que reflejara fortaleza, posición y experiencia.</p>
				</div>
				<div class="col-xs-12 col-sm-8">
					<img class="imagenes" src="img/capitol/logo.jpg" alt="">
				</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<img class="imagenes" src="img/capitol/todo.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
